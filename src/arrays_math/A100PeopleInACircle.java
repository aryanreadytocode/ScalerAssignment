...
* */
public class A100PeopleInACircle {
    /*
    * from the observation if the no of people in the circle is power of 2, always starting people will survive,
    * so for 100 people the nearest power of 2 is  64, so we need to kill 100-64= 26*2, 52 will be needed
    * so the person at 53 will survive*/
}
